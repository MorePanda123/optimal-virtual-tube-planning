...
function [x, u, exitflag,info] = optimizer_mpcc(TrackMPC,MPC_vars,ModelParams,  x, u,  x0, u0, num, Drone)
...
%     [new_b,~] = getNewBorders(TrackMPC.traj,TrackMPC.borders,TrackMPC.track_center,X,n_cars,1,MPC_vars,ModelParams);
    ...
    [xpred, upred,dupred,info] = getMPCmatrices(TrackMPC.traj,MPC_vars,ModelParams,x,u,x0,u0, num, Drone);
