...
function [x, u, exitflag,info] = optimizer_mpc_formation(time,pathNum,MPC_vars,...
...
%     [new_b,~] = getNewBorders(TrackMPC.traj,TrackMPC.borders,TrackMPC.track_center,X,n_cars,1,MPC_vars,ModelParams);
    ...
    [xpred, upred,dupred,info] = formation_getMPCmatrices(time,MPC_vars,...
        ModelParams,x,u,x0,u0, num, Drone,pathNum);
